    ...
    create or replace table `dwh-bootcamp-bigquery`.`latihan_dwh_bq_dbt_marts`.`mart_customer_cohort`
...
dim_customer as (
    select * from `dwh-bootcamp-bigquery`.`latihan_dwh_bq_dbt_marts`.`dim_customer`
),
